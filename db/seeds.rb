...
calendar_event_seeds = [
  ...
  { title: "Blitz", starts_at: Time.zone.parse("2027-07-25 18:00"), ends_at: Time.zone.parse("2027-07-25 21:30"), color: "#f4cccc" },
  { title: "Simultaneous games", starts_at: Time.zone.parse("2027-07-25 18:00"), ends_at: Time.zone.parse("2027-07-25 20:00"), color: "#b6d7a8" },
  # Monday 26th July
  ...
  { title: "Blitz Finals", starts_at: Time.zone.parse("2027-07-26 18:00"), ends_at: Time.zone.parse("2027-07-26 21:30"), color: "#f4cccc" },
  { title: "Senior Tmt R1", starts_at: Time.zone.parse("2027-07-26 18:00"), ends_at: Time.zone.parse("2027-07-26 19:30"), color: "#f4cccc" },
  { title: "Youth tmt R1", starts_at: Time.zone.parse("2027-07-26 18:00"), ends_at: Time.zone.parse("2027-07-26 19:30"), color: "#f4cccc" },
  ...
  { title: "Senior Tmt R2", starts_at: Time.zone.parse("2027-07-26 20:30"), ends_at: Time.zone.parse("2027-07-26 22:00"), color: "#f4cccc" },
  { title: "Youth tmt R2", starts_at: Time.zone.parse("2027-07-26 20:30"), ends_at: Time.zone.parse("2027-07-26 22:00"), color: "#f4cccc" },
  # Tuesday 27th July
  ...
  { title: "Fun go*", starts_at: Time.zone.parse("2027-07-27 15:00"), ends_at: Time.zone.parse("2027-07-27 17:30"), color: "#e06666" },
  { title: "Rapid R3", starts_at: Time.zone.parse("2027-07-27 16:00"), ends_at: Time.zone.parse("2027-07-27 17:30"), color: "#00ffff" },
  { title: "Senior Tmt R3", starts_at: Time.zone.parse("2027-07-27 18:00"), ends_at: Time.zone.parse("2027-07-27 19:30"), color: "#f4cccc" },
  { title: "Youth tmt R3", starts_at: Time.zone.parse("2027-07-27 18:00"), ends_at: Time.zone.parse("2027-07-27 19:30"), color: "#f4cccc" },
  ...
  { title: "Senior Tmt R4", starts_at: Time.zone.parse("2027-07-27 20:30"), ends_at: Time.zone.parse("2027-07-27 22:00"), color: "#f4cccc" },
  { title: "Youth tmt R4", starts_at: Time.zone.parse("2027-07-27 20:30"), ends_at: Time.zone.parse("2027-07-27 22:00"), color: "#f4cccc" },
  { title: "Joanna Koike", starts_at: Time.zone.parse("2027-07-27 22:00"), ends_at: Time.zone.parse("2027-07-27 23:00"), color: "#6fa8dc" },
  # Wednesday 28th July
  ...
  { title: "Nations Cup R1", starts_at: Time.zone.parse("2027-07-29 18:00"), ends_at: Time.zone.parse("2027-07-29 19:30"), color: "#f4cccc" },
  { title: "Fun go*", starts_at: Time.zone.parse("2027-07-29 18:00"), ends_at: Time.zone.parse("2027-07-29 20:30"), color: "#e06666" },
  ...
  { title: "Nations Cup R2", starts_at: Time.zone.parse("2027-07-29 20:30"), ends_at: Time.zone.parse("2027-07-29 22:00"), color: "#f4cccc" },
  # Friday 30th July
  ...
  { title: "Nations Cup R3", starts_at: Time.zone.parse("2027-07-30 18:00"), ends_at: Time.zone.parse("2027-07-30 19:30"), color: "#f4cccc" },
  ...
  { title: "Nations Cup R4", starts_at: Time.zone.parse("2027-07-30 20:30"), ends_at: Time.zone.parse("2027-07-30 22:00"), color: "#f4cccc" },
  # Saturday 31st July
  ...
  { title: "Reunion of Dutch Go Players", starts_at: Time.zone.parse("2027-08-01 16:00"), ends_at: Time.zone.parse("2027-08-01 22:30"), color: "#6fa8dc" },
  ...
  { title: "Main Open R6", starts_at: Time.zone.parse("2027-08-02 10:00"), ends_at: Time.zone.parse("2027-08-02 14:30"), color: "#c9daf8" },
  { title: "Game reviews by professionals", starts_at: Time.zone.parse("2027-08-02 12:00"), ends_at: Time.zone.parse("2027-08-02 17:30"), color: "#b6d7a8" },
  { title: "Lecture", starts_at: Time.zone.parse("2027-08-02 13:30"), ends_at: Time.zone.parse("2027-08-02 14:30"), color: "#fff2cc" },
  { title: "Fun go*", starts_at: Time.zone.parse("2027-08-02 15:00"), ends_at: Time.zone.parse("2027-08-02 17:30"), color: "#e06666" },
  { title: "Lecture", starts_at: Time.zone.parse("2027-08-02 15:00"), ends_at: Time.zone.parse("2027-08-02 16:00"), color: "#fff2cc" },
  ...
  { title: "Women tmt R1", starts_at: Time.zone.parse("2027-08-02 18:00"), ends_at: Time.zone.parse("2027-08-02 19:30"), color: "#f4cccc" },
  ...
  { title: "Women tmt R2", starts_at: Time.zone.parse("2027-08-02 20:30"), ends_at: Time.zone.parse("2027-08-02 22:00"), color: "#f4cccc" },
  # Tuesday 3rd August
  ...
  { title: "Women tmt R3", starts_at: Time.zone.parse("2027-08-03 18:00"), ends_at: Time.zone.parse("2027-08-03 19:30"), color: "#f4cccc" },
  ...
  { title: "Women tmt R4", starts_at: Time.zone.parse("2027-08-03 20:30"), ends_at: Time.zone.parse("2027-08-03 22:00"), color: "#f4cccc" },
  ...
  { title: "Prizegiving", starts_at: Time.zone.parse("2027-08-04 21:00"), ends_at: Time.zone.parse("2027-08-04 22:00"), color: "#ffd966" },
  # Thursday 5th August
  ...
  { title: "Rapid R8", starts_at: Time.zone.parse("2027-08-05 15:00"), ends_at: Time.zone.parse("2027-08-05 16:30"), color: "#00ffff" },
  ...
  { title: "Rapid R9", starts_at: Time.zone.parse("2027-08-06 15:00"), ends_at: Time.zone.parse("2027-08-06 16:30"), color: "#00ffff" },
  { title: "Pair go R4", starts_at: Time.zone.parse("2027-08-06 16:30"), ends_at: Time.zone.parse("2027-08-06 18:00"), color: "#f4cccc" },
  { title: "Fun go*", starts_at: Time.zone.parse("2027-08-06 18:00"), ends_at: Time.zone.parse("2027-08-06 22:00"), color: "#e06666" },
  ...
  { title: "Game reviews by professionals", starts_at: Time.zone.parse("2027-08-07 12:00"), ends_at: Time.zone.parse("2027-08-07 15:30"), color: "#b6d7a8" },
