module ApplicationHelper
  ...
  def social_media_icon(platform, css_class: "w-5 h-5")
    path = SOCIAL_MEDIA_ICON_PATHS[platform.to_s]
    return unless path

    content_tag(:svg, tag.path(d: path), class: css_class, fill: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true")
  end
