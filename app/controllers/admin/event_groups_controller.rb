module Admin
  class EventGroupsController < BaseController
    ...
    def create
      ...
      if @event_group.save
        redirect_to admin_event_groups_url, notice: "Event group was successfully created."
      else
    ...
    def update
      if @event_group.update(event_group_params)
        redirect_to admin_event_groups_url, notice: "Event group was successfully updated."
      else
    ...
    def destroy
      @event_group.destroy
      redirect_to admin_event_groups_url, notice: "Event group was successfully deleted."
    end
